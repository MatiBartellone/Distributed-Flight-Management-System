...
use super::utils::{to_hash_columns, to_hash_rows};
...
mod tests {
    use crate::{
        ...
        read_reparation::row_comparer::RowComparer,
        utils::types::timestamp::Timestamp,
    };
    ...
    fn test_better_3_responses() {
        let response_1 = vec![
            ...
            create_special_row(
                vec!["pk3"],
                vec![create_test_column("col1", "value3", 110)],
                false,
                110,
            ), //Best option
        ];
        ...
        let response_2 = vec![
            ...
            create_special_row(
                vec!["pk2"],
                vec![create_test_column("col1", "value2", 100)],
                true,
                100,
            ),
        ];
