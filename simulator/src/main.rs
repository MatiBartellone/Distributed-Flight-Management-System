...
fn main() {
    ...
    if let Ok(mut stream) = TcpStream::connect((node, 8080)) {
        let queries = vec![
            "INSERT INTO aviation.flightInfo (flightCode, positionLat, positionLon, altitude, speed, fuelLevel, status, departureAirport, departureTime, arrivalAirport, arrivalTime) VALUES ('AR1130', '41.6413', '-75.7787', '32000', '560', '85', 'OnTime', 'EZE', '08:30', 'SCL', '16:45');",
            ...
            "INSERT INTO aviation.flightInfo (flightCode, positionLat, positionLon, altitude, speed, fuelLevel, status, departureAirport, departureTime, arrivalAirport, arrivalTime) VALUES ('EK202', '25.2697', '55.3333', '36000', '600', '88', 'OnTime', 'DXB', '02:00', 'SCL', '07:30');",
            "INSERT INTO aviation.flightInfo (flightCode, positionLat, positionLon, altitude, speed, fuelLevel, status, departureAirport, departureTime, arrivalAirport, arrivalTime) VALUES ('CA981', '39.9042', '116.4074', '34000', '570', '74', 'OnTime', 'PEK', '06:45', 'SCL', '10:00');",
            "INSERT INTO aviation.flightInfo (flightCode, positionLat, positionLon, altitude, speed, fuelLevel, status, departureAirport, departureTime, arrivalAirport, arrivalTime) VALUES ('LH400', '50.1109', '8.6821', '32000', '565', '80', 'OnTime', 'FRA', '09:00', 'SCL', '12:00');",
            "INSERT INTO aviation.flightInfo (flightCode, positionLat, positionLon, altitude, speed, fuelLevel, status, departureAirport, departureTime, arrivalAirport, arrivalTime) VALUES ('SU100', '55.7558', '37.6173', '35000', '600', '81', 'OnTime', 'SVO', '08:30', 'SCL', '12:15');",
            "INSERT INTO aviation.flightInfo (flightCode, positionLat, positionLon, altitude, speed, fuelLevel, status, departureAirport, departureTime, arrivalAirport, arrivalTime) VALUES ('CX846', '22.3964', '114.1095', '33000', '585', '77', 'Delayed', 'HKG', '12:00', 'SCL', '16:30');",
            "INSERT INTO aviation.flightInfo (flightCode, positionLat, positionLon, altitude, speed, fuelLevel, status, departureAirport, departureTime, arrivalAirport, arrivalTime) VALUES ('AF006', '48.8566', '2.3522', '32000', '575', '79', 'OnTime', 'CDG', '10:00', 'SCL', '13:30');",
            "INSERT INTO aviation.flightInfo (flightCode, positionLat, positionLon, altitude, speed, fuelLevel, status, departureAirport, departureTime, arrivalAirport, arrivalTime) VALUES ('KE85', '37.5665', '126.9780', '35000', '590', '85', 'OnTime', 'ICN', '09:45', 'SCL', '11:00');",
            "INSERT INTO aviation.flightInfo (flightCode, positionLat, positionLon, altitude, speed, fuelLevel, status, departureAirport, departureTime, arrivalAirport, arrivalTime) VALUES ('JL006', '35.6895', '139.6917', '34000', '580', '72', 'OnTime', 'NRT', '13:30', 'SCL', '17:30');",
        ];
